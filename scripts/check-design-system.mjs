...
const semanticContractClaims = new Map([
  ["src/app/globals.css", [
    ...
    "var(--element-quote-foreground)",
    "var(--element-quote-surface)",
    "var(--element-quote-marker)",
    "var(--element-quote-marker-width)",
    "var(--element-quote-radius)",
    "var(--element-quote-font-weight)",
    "var(--element-quote-padding-block)",
    "var(--element-quote-padding-inline)",
    "var(--element-divider-inline-size)",
    "var(--element-divider-marker-size)",
    "var(--element-divider-spacing-block)",
    "var(--element-divider-width)",
    "var(--element-divider-color)",
    "var(--element-divider-marker)",
  ]],
  ...
  ["src/components/thread/topic-tag-link.tsx", ["@wenyousite/foundation/elements", "--element-topic-tag-min-height", "--element-topic-tag-foreground", "--element-topic-tag-focus-ring", "--element-topic-tag-font-weight", "hover:underline", "data-slot=\"topic-tag\""]],
...
const fullWidthCollectionClaims = new Map([
  ...
  ["src/components/user/user-follow-list.tsx", ["w-full divide-y divide-border", "flex w-full"]],
...
const elementDuplicateBans = new Map([
  ...
  ["src/components/thread/topic-tag-link.tsx", ["min-h-6", "rounded-full", "bg-[var(--element-topic-tag-surface)]", "border-[var(--element-topic-tag-border)]", "hover:bg-[var(--element-topic-tag-hover-surface)]"]],
