...
- `/me` 个人资料：在一个连续页面内编辑头像、用户名、个人简介、双画幅主页背景和主页公开范围；简介与隐私分别保存，等级、精确经验与累计收款默认折叠于底部
...
帖子和收藏 Tab 内不再重复同名标题；本人新建收藏夹按钮与收藏类型切换同行。隐私项使用“公开最近回复 / 公开参与的主题帖 / 公开收藏”，只有收藏项附“收藏夹名称与归类仅自己可见。”；无说明的控件不输出 aria-describedby。头像裁剪仅显示预览与缩放；背景裁剪保留同图分别裁剪、一起保存的规则。
