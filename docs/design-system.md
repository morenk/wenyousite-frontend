...
[`foundation.lock.json`](../foundation.lock.json) 固定到 `v6.0.1`，实现前必须读取同版本的：

- [`docs/foundation.md`](https://github.com/morenk/wenyousite-foundation/blob/v6.0.1/docs/foundation.md)
- [`docs/platforms/web.md`](https://github.com/morenk/wenyousite-foundation/blob/v6.0.1/docs/platforms/web.md)
- [`docs/elements.md`](https://github.com/morenk/wenyousite-foundation/blob/v6.0.1/docs/elements.md)
- [`docs/images.md`](https://github.com/morenk/wenyousite-foundation/blob/v6.0.1/docs/images.md)
- [`docs/icons.md`](https://github.com/morenk/wenyousite-foundation/blob/v6.0.1/docs/icons.md)
- [`docs/notifications.md`](https://github.com/morenk/wenyousite-foundation/blob/v6.0.1/docs/notifications.md)
- [`docs/interaction.md`](https://github.com/morenk/wenyousite-foundation/blob/v6.0.1/docs/interaction.md)
- [`docs/presentation.md`](https://github.com/morenk/wenyousite-foundation/blob/v6.0.1/docs/presentation.md)
- [`docs/navigation-language.md`](https://github.com/morenk/wenyousite-foundation/blob/v6.0.1/docs/navigation-language.md)
- [`contracts/foundation.v1.json`](https://github.com/morenk/wenyousite-foundation/blob/v6.0.1/contracts/foundation.v1.json)
