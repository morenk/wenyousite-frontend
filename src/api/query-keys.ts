...
export const queryKeys = {
  ...
  admin: {
    ...
    dashboardRange: (range: object) => ["admin", "dashboard", range] as const,
    health: ["admin", "health"] as const,
    usersRoot: ["admin", "users"] as const,
    user: (id: string) => ["admin", "users", "detail", id] as const,
    contentRoot: ["admin", "content"] as const,
    content: (params: object) => ["admin", "content", "list", params] as const,
    contentDetail: (type: string, id: string) => ["admin", "content", "detail", type, id] as const,
