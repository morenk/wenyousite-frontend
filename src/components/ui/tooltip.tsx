      ...
      <TooltipPrimitive.Portal>
        <TooltipPrimitive.Positioner side={side} sideOffset={7} className="z-[var(--layer-tooltip)]">
          <TooltipPrimitive.Popup
            role="tooltip"
            className={cn(
              "origin-(--transform-origin) rounded-[var(--radius-panel)] bg-foreground px-2.5 py-1.5 font-utility text-xs font-medium text-background shadow-popover outline-none",
